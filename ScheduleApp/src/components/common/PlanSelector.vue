<template>
  <Modal :visible="visible" @close="handleClose" title="选择计划" width="400px">
    <div class="plan-selector">
      ...
      <div class="plan-list">
        ...
        >
          ...
          <div class="plan-meta">
            <span
              :class="['status-badge', `status-${plan.status.toLowerCase()}`]"
            >
      ...
      <div class="modal-actions">
        <Button @click="handleClose" variant="outline"> 取消 </Button>
        <Button
