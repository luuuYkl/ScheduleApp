  ...
  <div class="ai-review-panel">
        ...
        <div class="metrics-grid">
          <div class="metric-card">
            ...
            <div class="metric-value">
              <span class="number"
                >{{ currentReview.metrics.completion_rate }}%</span
              >
            </div>
            <div class="metric-bar">
              <div
                class="metric-progress"
                :style="{ width: `${currentReview.metrics.completion_rate}%` }"
              ></div>
            </div>
          </div>
          ...
          <div class="metric-card">
            ...
            <div class="metric-value">
              <span class="number">{{
                currentReview.metrics.productivity_score
              }}</span>
            ...
            <div class="metric-bar">
              <div
                class="metric-progress"
                :style="{
                  width: `${currentReview.metrics.productivity_score}%`,
                }"
              ></div>
            </div>
          </div>
          ...
          <div class="metric-card">
            ...
            <div class="metric-value">
              <span class="number">{{
                currentReview.metrics.consistency_score
              }}</span>
              <span class="unit">/100</span>
            </div>
            <div class="metric-bar">
              <div
                class="metric-progress"
                :style="{
                  width: `${currentReview.metrics.consistency_score}%`,
                }"
              ></div>
            </div>
          </div>
    ...
    <div v-if="!loading && currentReview" class="review-actions">
      ...
      >
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
          <path
            d="M4 12a8 8 0 0 0 8 8c.28 0 .56 0 .83-.02M4 12a8 8 0 0 1 15.73-.5M4 12H2.5M21.5 12a8.973 8.973 0 0 0-1.67-4.73M12 2v3"
            stroke="currentColor"
            stroke-width="2"
