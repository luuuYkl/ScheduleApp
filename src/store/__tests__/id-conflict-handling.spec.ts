...
describe('ID冲突处理策略测试', () => {
  ...
  describe('createPlan ID冲突处理', () => {
    ...
    it('应该正确处理多个计划的ID冲突', async () => {
      // 设置多个初始计划
      const plans = [
        { id: 1, user_id: 1, title: '计划1', start_date: '2024-01-01', end_date: '2024-01-31', frequency: 'daily' },
        { id: 2, user_id: 1, title: '计划2', start_date: '2024-02-01', end_date: '2024-02-29', frequency: 'weekly' },
        { id: 3, user_id: 1, title: '计划3', start_date: '2024-03-01', end_date: '2024-03-31', frequency: 'monthly' }
      ];
      ...
      expect(planStore.plans.find(p => p.id === 2)?.title).toBe('计划2-已更新');
      // 其他计划应该保持不变
  ...
  describe('边界情况测试', () => {
    ...
    it('应该处理ID为0的特殊情况', async () => {
      planStore.plans = [{ id: 0, user_id: 1, title: '零号计划', start_date: '2024-01-01', end_date: '2024-01-31', frequency: 'daily' }];
  ...
  describe('性能考虑', () => {
    it('应该在大量计划情况下仍能正确处理', async () => {
      ...
      expect(planStore.plans.find(p => p.id === 50)?.title).toBe('计划50-已更新');
